 ...
 */
public class PorterStemmatiser implements Stemmatiser {
    ...
    public List<String> performStemmatisation(List<String> tokens){
        ...
        for (String tok : tokens) {
            ...
            i = 0;
            i_end = 0;
            this.add(tok.toCharArray(), tok.length());
            this.stem();
    ...
    */
    ...
    {
       char[] w = new char[501];
       PorterStemmatiser s = new PorterStemmatiser();
